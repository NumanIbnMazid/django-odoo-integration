...
SECRET_KEY = 'ibwkmigvq_ixf=5eld8vm37=50em9mt3fwxwkd2v7w9o%h9gvz'
...
ROOT_URLCONF = 'django_odoo_project.urls'
...
WSGI_APPLICATION = 'django_odoo_project.wsgi.application'
